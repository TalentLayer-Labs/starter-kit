  ...
  return (
    <div className='bg-info group relative hidden w-1/2 items-center justify-around overflow-hidden bg-gradient-to-tr md:flex'>
      <div className='mx-auto max-w-xs text-center'>
        <h2 className='font-heading text-3xl font-medium leading-normal text-base mb-4'>{title}</h2>
        <p className='font-alt text-sm font-normal leading-normal text-base mb-3'>{subtext}</p>
      </div>
