                ...
                <div className='wow fadeInUp mb-12 lg:mb-0 lg:max-w-[570px]' data-wow-delay='.2s'>
                  ...
                  <div className='flex flex-wrap items-center'>
                    <div className='mr-[60px] flex items-center justify-end lg:mr-0'>
                      <a
                        href='/onboarding'
                        className='rounded-md bg-redpraha py-[6px] px-[12px] xl:py-[10px] xl:px-[30px] text-base font-medium text-stone-800 hover:bg-opacity-90'>
                        Create a BuilderPlace
                      </a>
                      <a
                        href='/worker-onboarding'
                        className='rounded-md bg-midnight ml-2 py-[6px] px-[12px] xl:py-[10px] xl:px-[30px] text-base font-medium text-stone-800 hover:bg-opacity-90'>
              ...
              <div className='w-full px-3 md:w-1/2 lg:w-1/3'>
                <div className='mb-4 flex items-center justify-center space-x-5 md:mb-0 md:justify-start lg:justify-center'>
                  <a
                    ...
                    className='text-stone-800 opacity-70 hover:opacity-100'
                    target='_blank'
