      ...
      <div className=' -mx-6 -mt-6 sm:mx-0 sm:mt-0'>
        <div className='flex py-2 px-6 sm:px-0 items-center border-b w-full border-gray-700 mb-8'>
          <p className='text-2xl font-medium flex-1'>
            Send <span className='text-gray-100 ml-1'>Web3mails</span>
          </p>
          <a
            href={`/admin/web3mail/stats`}
            className='  text-white bg-endnight px-3 py-2 text-sm flex items-center rounded-xl'>
            <ChartBarIcon width={18} height={18} className='w-[18px] h-[18px] text-redpraha mr-2' />
            Stats
          </a>
        </div>
      </div>
