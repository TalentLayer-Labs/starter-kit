          ...
          <div
            className={`py-3 px-4 text-sm ${
              isSender && message.status === ChatMessageStatus.SENT
                ? 'ml-12 bg-redpraha text-stone-800 rounded-bl-2xl rounded-tl-2xl rounded-tr-xl'
                ...
                ? 'ml-12 bg-midnight text-stone-800 rounded-bl-2xl rounded-tl-2xl rounded-tr-xl'
                : 'mr-12 bg-midnight text-stone-800 rounded-br-2xl rounded-tr-2xl rounded-tl-xl'
            }
          text-stone-800`}>
